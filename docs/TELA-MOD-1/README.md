...
```go
import (
	"github.com/secretnamebasis/simple-tela"
)
...
The `var_header_` prefix builds upon the existing [ART-NFA header standard](https://github.com/secretnamebasis/artificer-nfa-standard/blob/main/Headers/README.md), allowing names, descriptions, and icons to be individually updated.
| Key                    | Value   | Usage Description                                               | Examples          |
|------------------------|---------|-----------------------------------------------------------------|-------------------|
