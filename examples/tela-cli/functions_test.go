...
// 		// Valid git clone
// 		err = gitClone("github.com/secretnamebasis/simple-tela@main")
// 		assert.NoError(t, err, "Cloning valid repo should not error: %s", err)

// 		// Invalid git clone
// 		err = gitClone("https://github.com/secretnamebasis/simple-tela")
// 		assert.Error(t, err, "Cloning with long form URL should error")
// 		err = gitClone("github.com/secretnamebasis/simple-tela.git")
